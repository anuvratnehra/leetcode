...
public:
    void leftTraversal(Node *root, vector<int> &ans){
        if(root){
            ...
            if(root->left==NULL) leftTraversal(root->right,ans);
    ...
    void rightTraversal(Node *root, vector<int> &ans){
        if(root){
            if(root->left==NULL and root->right==NULL) return;
            ans.push_back(root->data);
            if(root->right==NULL) rightTraversal(root->left,ans);
            else rightTraversal(root->right,ans);
        }
    }
    ...
    vector <int> boundary(Node *root)
    {
        ...
        rightTraversal(root->right,rightV);
